...
public class HanziToPinyin {
    ...
    public static HanziToPinyin getInstance() {
        synchronized (HanziToPinyin.class) {
            ...
            logger.warn("There is no Chinese collator, HanziToPinyin is disabled");
    ...
    public ArrayList<Token> get(final String input) {
        ...
        if (!mHasChinaCollator || StringUtils.isEmpty(input)) {
            // return empty tokens.
            return tokens;
        }
    ...
    static Logger logger = LoggerFactory.getLogger(HanziToPinyin.class);
}
