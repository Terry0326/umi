...
public class OKWebResponseExceptionTranslator implements WebResponseExceptionTranslator {
...
//                HttpStatus.valueOf(status));
        ResponseEntity<OAuth2Exception> response = new ResponseEntity<>(e, headers, HttpStatus.OK);
        return response;
